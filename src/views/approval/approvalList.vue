...
<script>
import { approve,getApproveList} from '@/api/approve'
...
export default {
  ...
  methods: {
    ...
    getInitData(){
      ...
      getApproveList({safeUserId:this.userInfo.id}).then(res => {
      ...
      getApproveList({deviceUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
      ...
      getApproveList({produceUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
      ...
      getApproveList({projectUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
      ...
      getApproveList({controlUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
      ...
      getApproveList({tutelageUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
      ...
      getApproveList({leadUserId:this.userInfo.id}).then(res => {
        if(res.data.length > 0){
          res.data.forEach(item => {
            this.approveData.push(item)
          })
